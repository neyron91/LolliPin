...
public class FingerprintUiHelper extends FingerprintManager.AuthenticationCallback {
   ...
   private final long successFingerprintDelayMillis;
   /**
   ...
   private FingerprintUiHelper(
         ...
         long successFingerprintDelayMillis,
         ImageView icon, TextView errorTextView, Callback callback) {
      this.successFingerprintDelayMillis = successFingerprintDelayMillis;
      mFingerprintManager = fingerprintManager;
      mIcon = icon;
      mErrorTextView = errorTextView;
      mCallback = callback;

      mResetErrorTextRunnable.run();
   }
   ...
   public void onAuthenticationSucceeded(FingerprintManager.AuthenticationResult result) {
      ...
      }, this.successFingerprintDelayMillis);
   }
   ...
   public static class FingerprintUiHelperBuilder {
      private final FingerprintManager mFingerPrintManager;
      private long mFingerprintSuccessfulDelayMillis = SUCCESS_DELAY_MILLIS;

      public FingerprintUiHelperBuilder(FingerprintManager fingerprintManager) {
         mFingerPrintManager = fingerprintManager;
      }

      public FingerprintUiHelperBuilder setFingerprintSuccessfulDelayMillis(long mFingerprintSuccessfulDelayMillis) {
         this.mFingerprintSuccessfulDelayMillis = mFingerprintSuccessfulDelayMillis;
         return this;
      }

      public FingerprintUiHelper build(ImageView icon, TextView errorTextView, Callback callback) {
         return new FingerprintUiHelper(mFingerPrintManager, mFingerprintSuccessfulDelayMillis, icon, errorTextView, callback);
      }
   }
}
